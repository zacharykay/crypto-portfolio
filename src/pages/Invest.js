          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <h3>
              <label htmlFor="initial_investment">
                <span className="lowpacity">STEP 1:</span> Choose your initial investment
              </label>{" "}
            </h3>
            ...
            <span> &nbsp;USD</span>
            <h3>
              <span className="lowpacity">STEP 2:</span> Choose your cryptocurrencies
              &nbsp;&nbsp;&nbsp;{" "}
              <span className="amount-counters">
                <span
                  ...
                  data-test="amountInvested"
                >
                  {dollarPrice(totalCryptoAmount)}{" "}
                  <span className="lowpacity">Invested</span>
                </span>{" "}
                <span>&nbsp;&nbsp;</span>
                <span data-test="amountRemaining">
                  {remainingAmount >= 0 ? dollarPrice(remainingAmount) : 0}
                </span>{" "}
            ...
            <div className="create-portfolio">
              <h3>
                <span className="lowpacity">STEP 3:</span> Confirm your selections
              </h3>
              <div className="create-portfolio-btn">
                ...
                remainingAmount < initialInvestment && (
                  <span className="negative">
                    ...
                    <span className="lowpacity">Budget Remaining</span>
                  </span>
                )}
              </div>
            </div>
